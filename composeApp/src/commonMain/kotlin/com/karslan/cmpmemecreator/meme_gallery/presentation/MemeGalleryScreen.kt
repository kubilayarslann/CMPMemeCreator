package com.karslan.cmpmemecreator.meme_gallery.presentation
...
import com.karslan.cmpmemecreator.core.presentation.memeTemplates
...
fun MemeGalleryScreen(
    onMemeTempSelected: (MemeTemplate) -> Unit
) {
